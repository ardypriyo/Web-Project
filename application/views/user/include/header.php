...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/sweetalert-master/dist/sweetalert.css' ?>">s
</head>
<body>
          ...
          <ul>
    		...
    		<li class="submenu">
    			<a href="#">
      			...
      			<ul>
        			<li><a href="<?php echo base_url().'User' ?>"><i class="icon icon-user"></i> <span>User</span></a></li>
        			<li><a href="<?php echo base_url().'Web_setting' ?>"><i class="icon icon-cogs"></i> <span>Setting</span></a></li>
      			</ul>
    		</li>
  		</ul>
	</div>
