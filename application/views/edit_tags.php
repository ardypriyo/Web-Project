                ...
                <div class="span6">
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form action="<?php echo base_url().'tags/update'; ?>" method="post" class="form-horizontal">
                                <div class="control-group">
                                    <label class="control-label">tags</label>
                                    <div class="controls">
                                        <input type="text" name="tags" class="span11" required="" value="<?php echo $tags; ?>" />
                                        <input type="hidden" name="id_tags" value="<?php echo $id_tags; ?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea rows="5" name="deskripsi" class="span11">
                                            <?php
                                                echo $deskripsi;
                                            ?>
                                        </textarea>
