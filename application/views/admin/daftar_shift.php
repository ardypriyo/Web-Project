                                    ...
                                    foreach($shift as $row)
                                    {
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url().'shift/edit/'.$row['id_shift'] ?>" class="btn btn-mini btn-warning">
                                                        <span class="icon"></span><i class="icon-pencil"></i>
                                                    </a>

                                                    <a href="" class="btn btn-mini btn-danger AlertaEliminarCliente" data-id="<?php echo $row['id_shift'] ?>">
