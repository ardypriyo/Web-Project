...
?>
    ...
    <div id="content-header">
        <div id="breadcrumb">
            ...
            <a href="">Tambah Master Absensi</a>
        </div>
    </div>
    <!--End-breadcrumbs-->
    		...
    		<div class="span6">
    			<div class="widget-box">
    				...
    				<div class="widget-content">
    					<form method="post" action="<?php echo base_url().'absensi/simpan' ?>" class="form-horizontal">
                            ...
                            <div class="control-group">
                            	...
                            	<div class="controls">
                            		<input type="text" name="kode_absensi" class="span4" maxlength="5" required="">
                            ...
                            <div class="control-group">
                            	...
                            	<div class="controls">
                            		<input type="text" name="keterangan" class="span11" maxlength="100">
                            ...
                            <div class="control-group">
                            	...
                            	<div class="controls">
                            		<select name="tipe" class="span11">
                            			<option value="0">False - Hitung Alpha</option>
                            			<option value="1">True - Hitung Hadir</option>
                            		</select>
                            	</div>
                            </div>
