            ...
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="widget-content">
                        <form method="post" action="<?php echo base_url().'periode_absen/update' ?>" class="form-horizontal">
                            <div class="control-group">
                                <label class="control-label">Keterangan</label>
                                <div class="controls">
                                    <input type="text" name="keterangan" class="span6" maxlength="100" required="" value="<?php echo $keterangan;  ?>">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="tgl_mulai" data-date-format="yyyy-mm-dd" class="datepicker span6" value="<?php echo $tgl_mulai;  ?>">
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">Tanggal Selesai</label>
                                <div class="controls">
                                    <input type="text" name="tgl_selesai" data-date-format="yyyy-mm-dd" class="datepicker span6" value="<?php echo $tgl_selesai;  ?>">
                                </div>
                            </div>
                            <div class="control-group">
