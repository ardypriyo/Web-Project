...
?>
	...
	<div id="content-header">
        <div id="breadcrumb">
        	...
        	<a href="" title="Go to User List" class="tip-bottom">Content</a>
            <a href="<?php echo base_url().'kategori' ?>" title="Go to User List" class="tip-bottom">Kategori</a>
    		...
    		<div class="span6">
    			<div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                    	<form action="<?php echo base_url().'artikel/update'; ?>" method="post" class="form-horizontal">
                    		<div class="form-actions">
                                <a href="<?php echo base_url().'kategori/edit/'.$id_kategori ?>" class="btn btn-success">
                                    <span class="icon"></span><i class="icon-edit"></i> Edit
                                </a>
