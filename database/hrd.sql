...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 08, 2018 at 09:39 PM
...
--
-- Table structure for table `hrd_email_config`
--

CREATE TABLE `hrd_email_config` (
...
--
-- Dumping data for table `hrd_email_config`
--

INSERT INTO `hrd_email_config` (`nama_pengirim`, `smtp_host`, `smtp_user`, `smtp_password`, `smtp_port`, `keamanan`) VALUES
('', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `hrd_kebangsaan`
--

CREATE TABLE `hrd_kebangsaan` (
  `nama_negara` varchar(50) NOT NULL,
  `status` int(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `hrd_kebangsaan`
--

INSERT INTO `hrd_kebangsaan` (`nama_negara`, `status`) VALUES
('Afganistan', 1),
('Afrika Selatan', 1),
('Albania', 1),
('Aljazair', 1),
...
('Kepulauan Faroe', 1),
('Kepulauan Mariana Utara', 1),
('Kepulauan Marshall', 1),
('Kepulauan Pitcairn', 1),
('Kepulauan Turks dan Caicos', 1),
('Kepulauan Virgin', 1),
('Kepulauan Virgin Inggris', 1),
('Kirgizia', 1),
('Kiribati', 1),
('Kolombia', 1),
('Komoro', 1),
...
('Papua Nugini', 1),
('Paraguay', 1),
('Perancis (Metropolitan)', 1),
('Peru', 1),
('Polandia', 1),
('Polinesia Perancis', 1),
('Portugal', 1),
('Puerto Riko', 1),
('Pulau Man', 1),
('Pulau Natal', 1),
...
('Sahara Barat', 1),
('Saint Helena', 1),
('Saint Kitts dan Nevis', 1),
('Saint Lucia', 1),
('Saint Pierre dan Miquelon', 1),
('Saint Vincent dan Grenadines', 1),
('Samoa', 1),
('Samoa Amerika', 1),
('San Marino', 1),
('Sao Tome dan Principe', 1),
('Selandia Baru', 1),
('Senegal', 1),
('Serbia dan Montenegro', 1),
('Seychelles', 1),
('Sierra Leone', 1),
('Singapura', 1),
('Siprus', 1),
...
(1, '0', '', 'admin', 'YWRtaW4=', 'admin', 'priyo.ardy@yahoo.com', 1, 0, '2018-03-08 14:34:27', '', '0000-00-00 00:00:00', '', '2018-03-08 20:28:14');
